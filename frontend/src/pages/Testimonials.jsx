...
const FALLBACK = [
  ...
  { _id: 't2', clientName: 'Anjali Kulkarni', clientRole: 'Business Owner, Warje', rating: 5, message: 'Professional, punctual, and genuinely talented. Our penthouse interiors exceeded expectations.' },
